...
class Grid():
    ...
    def best_shape(self, cropped_img):
        ...
        circle = CircleCell.find_best(cropped_img, n=4, sn=2, base_color=base_color, second_color=second_color, colorful=self.is_colorful)
        ...
        pie = PieSliceCell.find_best(cropped_img, n=4, sn=3, base_color=base_color, second_color=second_color, colorful=self.is_colorful)
        halfc = HalfCircleCell.find_best(cropped_img, n=4, sn=2, base_color=base_color, second_color=second_color, colorful=self.is_colorful)
